...
public class GreetingAspect {
	...
	/*@Before(value = "com.tokioschool.spring.aspects.pointcuts.GreetingServicePointcuts.greetingSayHelloPointCut()") // Punto de corte, si es una interfaz se aplica a cualquier clase que implemente una interfza
	...
	@After(value = "com.tokioschool.spring.aspects.pointcuts.GreetingServicePointcuts.greetingSayHelloPointCut()") // Punto de corte, si es una interfaz se aplica a cualquier clase que implemente una interfza
	...
	@Around(value = "com.tokioschool.spring.aspects.pointcuts.GreetingServicePointcuts.greetingSayHelloPointCut()") // Punto de corte, si es una interfaz se aplica a cualquier clase que implemente una interfza
	...
	@AfterReturning("com.tokioschool.spring.aspects.pointcuts.GreetingServicePointcuts.greetingStringStartParamPointCut()")
